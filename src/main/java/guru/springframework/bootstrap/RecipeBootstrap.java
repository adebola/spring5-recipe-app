...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        if (!eachUoMOptional.isPresent()) {
            throw new RuntimeException("Exception UOM Each Not Found");
        }

        Optional<UnitOfMeasure> tableUoMOptional = unitofMeasureRepository.findByUom("Tablespoon");
        if (!tableUoMOptional.isPresent()) {
            throw new RuntimeException("Exception UOM Tablespoon Not Found");
        }

        Optional<UnitOfMeasure> teaUoMOptional = unitofMeasureRepository.findByUom("Teaspoon");
        if (!teaUoMOptional.isPresent()) {
            throw new RuntimeException("Exception UOM teaspoon Not Found");
        }

        Optional<UnitOfMeasure> dashUoMOptional = unitofMeasureRepository.findByUom("Teaspoon");
        if (!dashUoMOptional.isPresent()) {
            throw new RuntimeException("Exception UOM Dash Not Found");
        }
        ...
        tacosRecipe.setUrl("https://www.simplyrecipes.com/recipes/fish_taco_salad_bowl/");
